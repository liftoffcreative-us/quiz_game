...
const Questions = () => {
  ...
  return (
    ...
    <div className='flex flex-col items-center  justify-center w-3/4 h-3/4 px-4 py-2'>
        ...
        <Link href="/categories" id='timesUp' className='fixed z-50  h-full w-full flex items-center justify-center' style={{visibility: 'hidden'}} >
        ...
        <section id="topSection" className='flex items-center w-full h-1/2  overflow-hidden'>
         <Image src="/9.jpg" alt="Category Image"width={1300} height={900} className='mt-4 ml-2 bg-question-bg bg-cover w-[55%] h-full rounded-md ' />
        ...
        <section id="bottomSection" className='flex w-full h-1/2 '>
            ...
            <div id="questionSection" className='flex flex-col items-start justify-center w-3/4 h-full p-6'>
                <div id="question" className='text-2xl w-full h-1/3 '>{questionData.data.question}</div>
