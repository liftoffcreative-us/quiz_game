...
export default function ScoreBoardPage() {
  ...
  return (
    <div className="flex items-center justify-center w-full h-full bg-game-bg ">
      <div
        id="scoreBoard"
        className="w-full h-full  flex items-center justify-start p-12 flex-col flex-wrap gap-2"
      >
        <Image
          ...
          {players.map((player, index) => {
            return (
              <div
                key={index}
                id="playerCard"
                className="flex w-full h-[12vh] mt-2 items-center"
              >
                <div
                ...
                <div className="absolute  ml-8 flex flex-col justify-center">
                  <div
                    className={`${playerFont.className} text-[1vw] justify-self-start -mt-2 `}
                  >
                    {player.name}
                  </div>
                  <div id="stars" className="flex w-[8vw] gap-2">
                    <svg
                ...
                <div className="absolute flex flex-col items-center justify-center ml-[13vw] ">
                  ...
                  <Image
                    ...
                    width={100}
                    height={100}
                    className="absolute w-[4vw] h-[4vw]  rounded-full overflow-hidden"
                  />
                </div>
              </div>
            );
